<?php include "header.php" ?>
    ...
    <div class="d-flex justify-content-center mb-3">
        <form action="actionUsuario.php" method="POST" class="was-validated">
            ...
            <div class="form-floating mt-3 mb-3">
                <input type="date" name="dataNascimentoUsuario" id="dataNascimentoUsuario" placeholder="Data de nasciemnto" class="form-control" >
                <label for="dataNascimentoUsuario">Data de nasciemento</label>
                <div class="valid-feedback"></div>
                <div class="invalid-feedback"></div>
            </div>
            ...
            <div class="form-floating mt-3 mb-3">
                <input type="password" name="senhaUsuario" id="senhaUsuario" placeholder="senha" class="form-control" minlength="6" maxlength="10" >
            ...
            <div class="form-floating mt-3 mb-3">
                <input type="password" name="confirmarSenhaUsuario" id="confirmarSenhaUsuario" placeholder=" Confirme a senha" class="form-control" minlength="6" maxlength="10" >
