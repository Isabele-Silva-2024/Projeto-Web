<?php include "header.php" ?>
    <?php
        //Verificar se o método de envio das informações do form é "POST"
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            //Cria variáveis para armazenar informações recebidas do array $_POST
            ...
            if (empty($_POST["dataNascimentoUsuario"])){
                ...
                //Utiliza a função strlen() para verificar o comprimento da string $dataNascimentoUsuario
        ...
        //Função para filtrar entrada de4 dados e enviar SQL Injection
